...
import io.github.diskria.lapis.extensions.capitalize
import io.github.diskria.lapis.extensions.common.Builder
import io.github.diskria.lapis.extensions.common.lapisError
import io.github.diskria.lapis.extensions.jp.*
import io.github.diskria.lapis.extensions.kp.*
import io.github.diskria.lapis.extensions.withInternalPrefix
...
import io.github.diskria.lapis.phases.builtins.LocalVarImplBuiltin
import io.github.diskria.lapis.phases.builtins.SimpleBuiltin
import io.github.diskria.lapis.phases.generator.builders.*
import io.github.diskria.lapis.phases.generator.models.GenExtensionPack
import io.github.diskria.lapis.phases.generator.models.GenExtensionPackAccumulator
import io.github.diskria.lapis.phases.generator.models.GenInternalPrefix.*
import io.github.diskria.lapis.phases.generator.models.GenMixinConfig
import io.github.diskria.lapis.phases.generator.models.GenTweakAccessorConfig
...
import io.github.diskria.lapis.phases.lowering.asIrParameterizedTypeName
import io.github.diskria.lapis.phases.lowering.asIrTypeName
import io.github.diskria.lapis.phases.lowering.models.*
import io.github.diskria.lapis.phases.lowering.models.common.*
...
class Generator(
    ...
    private fun generateJavaFile(
        ...
        codeGenerator.createNewFile(
            ...
            packageName = blueprint.className.packageName.orEmpty(),
            fileName = name,
            extensionName = "java",
