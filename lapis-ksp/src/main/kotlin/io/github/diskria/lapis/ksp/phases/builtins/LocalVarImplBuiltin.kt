...
import io.github.diskria.lapis.ksp.phases.builtins.SimpleBuiltin.LocalVar
...
import io.github.diskria.lapis.ksp.phases.lowering.models.IrSetterParameter
...
enum class LocalVarImplBuiltin(
    ...
    companion object {
        fun of(valueTypeName: IrTypeName): LocalVarImplBuiltin =
            entries.find { valueTypeName == it.valueKPClassName?.asIrClassName() } ?: ObjectLocalVar
    }
}
